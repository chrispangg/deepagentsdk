...
<Callout title="Which Runtime?" type="idea">
- **Node.js 18+**: Recommended for production applications
- **Bun**: Faster for development and testing
- Both work perfectly with the published npm package!
</Callout>
...
<Tabs items={['Node.js (npm)', 'Node.js (yarn/pnpm)', 'Bun', 'CLI Global']}>
  <Tab value="Node.js (npm)">
    ```bash
    ...
    # Install tsx for TypeScript execution (dev)
    npm install --save-dev tsx typescript @types/node
    ```
  </Tab>
  <Tab value="Node.js (yarn/pnpm)">
    ```bash
    # Using yarn
    yarn add deepagentsdk @ai-sdk/anthropic @ai-sdk/openai dotenv
    yarn add -D tsx typescript @types/node

    # Using pnpm
    pnpm add deepagentsdk @ai-sdk/anthropic @ai-sdk/openai dotenv
...
<Callout title="📖 Complete Node.js Guide" type="info">
  See **[Node.js Usage Guide](../../../NODEJS-USAGE.md)** for detailed Node.js setup, examples, and troubleshooting.
</Callout>
...
<Tabs items={['Node.js', 'Bun']}>
  <Tab value="Node.js">
    ```bash
    # Make sure to add 'dotenv' import at the top of agent.ts
...
<Tabs items={['Node.js', 'Bun']}>
  <Tab value="Node.js">
    ...
    # With specific model
    npx deepagentsdk --model anthropic/claude-sonnet-4-5-20250929
    ```
  </Tab>
  <Tab value="Bun">
    ```bash
    ...
    # With specific model
    bunx deepagentsdk --model anthropic/claude-sonnet-4-5-20250929
    ```
  </Tab>
</Tabs>
...
- ✅ Installed the package with Node.js or Bun
- ✅ Configured API keys
...
**Node.js users:** Check out the **[Complete Node.js Usage Guide](../../../NODEJS-USAGE.md)** for production deployment patterns, Docker setup, and framework integrations.
</Callout>
