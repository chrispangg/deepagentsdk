...
## What NOT to Do: The Organizational Chart Anti-Pattern

Here's a real example of the wrong approach:

<img src="/blog/assets/tweet-2004597085467983965.png" alt="Tweet showing elaborate agent hierarchy" style={{ maxWidth: '500px', width: '100%' }} />

This structure—with domain-specific agents like `frontend-developer`, `backend-architect`, `mobile-app-builder`, `tiktok-strategist`, etc.—is precisely what you should **NOT** build. It treats subagents as team members with job titles rather than as context compression functions. Each agent becomes a silo, coordination overhead explodes, and information gets lost between handoffs.

The rest of this post explains why this fails and what to do instead.
