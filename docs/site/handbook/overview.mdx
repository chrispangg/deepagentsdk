---
title: Deep Agent Overview
description: Build agents that can plan, use subagents, and leverage file systems for complex tasks
---

**deepagentsdk** is a TypeScript library for building agents that can tackle complex, multi-step tasks. Built on Vercel AI SDK v6 and inspired by applications like Claude Code, Deep Research, and LangChain's DeepAgents, this library provides:
...
**deepagentsdk** is built on top of:
...
**deepagentsdk** wraps AI SDK's `ToolLoopAgent` with additional capabilities:
...
| Feature | LangChain | deepagentsdk |
|---------|-----------|-------------------|
...
| CLI | `uvx deepagents-cli` | `bunx deepagentsdk` ✅ |
